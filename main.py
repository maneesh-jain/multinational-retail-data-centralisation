...
if __name__ == '__main__':
    ...
    '''Connects to AWS RDS, lists tables in database.'''
    db_creds = 'C:\\Users\\Maneesh\\Documents\\AiCore\lessons\\retail\\rds_creds.yaml'
    ...
    def users_and_orders():
        ...
        db_creds = 'C:\\Users\\Maneesh\\Documents\\AiCore\lessons\\retail\\postgres_creds.yaml'
        db = DatabaseConnector(db_creds)
